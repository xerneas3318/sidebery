...
- サブパネルとポップアップウィンドウを閉じる`,
  ...
  'snapshot.btn_open_in_single_win': {
    en: 'Open in one window',
    de: 'In einem Fenster öffnen',
    fr: 'Ouvrir dans une seule fenêtre',
    hu: 'Megnyitás egy ablakban',
    pl: 'Otwórz w jednym oknie',
    ru: 'Открыть в одном окне',
    zh_CN: '在一个窗口中打开',
    zh_TW: '在單一視窗中開啟',
    ja: '1つのウィンドウで開く',
  },
